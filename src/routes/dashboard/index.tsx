...
const demoKits: Kit[] = [
  { id: "k1", name: "Intro Kit", topicId: "t1", tags: ["basics", "orientation"] },
  { id: "k2", name: "Ecosystems", topicId: "t2", tags: ["food chain", "habitats"] },
  { id: "k3", name: "Stars and Planets", topicId: "t3", tags: ["planets", "constellation"] },
  { id: "k4", name: "Maps 101", topicId: "t4", tags: ["cartography", "gps"] },
  { id: "k5", name: "Cell Biology", topicId: "t2", tags: ["cells", "microscope"] },
];
...
function JoinKitDialog({
  ...
  const kitsForTopic = useMemo(
    () => demoKits.filter((k) => (!selectedTopicId ? true : k.topicId === selectedTopicId)),
    [selectedTopicId],
  );
                  ...
                  <li key={k.id}>
                    ...
                    >
                      <div className="flex items-start justify-between gap-3">
                        ...
                        {active ? <Check className="mt-1 size-4 shrink-0" /> : null}
                      </div>
                    </button>
                  </li>
                );
        ...
        <div className="rounded-lg border p-4 space-y-2">
          ...
          <div className="flex gap-2">
            <Button asChild className="mt-1">
              <Link to="/dashboard/goal/$goalMapId" params={{ goalMapId: "new" }} preload="intent">
                New Goal Map
              </Link>
            </Button>
          </div>
