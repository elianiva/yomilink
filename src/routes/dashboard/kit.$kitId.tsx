...
import ImageNode, { type ImageNodeData } from "@/components/kit/nodes/ImageNode";
...
const initialEdges: Edge[] = [
  { id: "e1-2", source: "n1", target: "n2", style: { stroke: "#16a34a", strokeWidth: 1.5 } },
  { id: "e2-3", source: "n2", target: "n3", style: { stroke: "#16a34a", strokeWidth: 1.5 } },
  { id: "e2-4", source: "n2", target: "n4", style: { stroke: "#16a34a", strokeWidth: 1.5 } },
];
...
function KitWorkspace() {
  ...
  const handleSave = () => {
    const viewport =
      rfRef.current?.getViewport?.() ?? { x: 0, y: 0, zoom: 1 };
      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center gap-2">
          <div className="inline-flex items-center gap-1 rounded-md border p-1">
            ...
            <Button size="default" variant="ghost" onClick={zoomOut} title="Zoom out">
              <ZoomOut className="size-4" />
            </Button>
            <Button size="default" variant="ghost" onClick={zoomIn} title="Zoom in">
              <ZoomIn className="size-4" />
            </Button>
            <Button size="default" variant="ghost" onClick={fit} title="Fit view">
