...
describe("GoalMapValidator", () => {
	it("should validate a correct KBFIRA structure", () => {
		const nodes = [
			{
				id: "root",
				type: "text",
	...
	it("should reject goal map with insufficient nodes", () => {
		const nodes = [
			{
				id: "root",
				type: "text",
	...
	it("should reject goal map with insufficient connectors", () => {
		const nodes = [
			{
				id: "root",
				type: "text",
	...
	it("should reject goal map with insufficient edges", () => {
		const nodes = [
			{
				id: "root",
				type: "text",
	...
	it("should reject goal map with non-unique node IDs", () => {
		const nodes = [
			{
				id: "root",
				type: "text",
	...
	it("should reject goal map with invalid edge references", () => {
		const nodes = [
			{
				id: "root",
				type: "text",
	...
	it("should reject goal map with disconnected connectors", () => {
		const nodes = [
			{
				id: "root",
				type: "text",
		...
		expect(result.isValid).toBe(false);
		expect(
			result.errors.some((e: string) => e.includes("has no") && e.includes("connections")),
		).toBe(true);
	});

	it("should compose propositions correctly", () => {
		const nodes = [
			{
				id: "cat",
				type: "text",
	...
	it("should warn about disconnected concept nodes", () => {
		const nodes = [
			{
				id: "root",
				type: "text",
