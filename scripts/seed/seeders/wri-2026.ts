...
const FRONTEND_MATERIAL_DATA = {
	...
	edges: [
		...
		{ id: "e7", source: "html", target: "conn-tags" },
		{ id: "e8", source: "conn-tags", target: "tags" },
		{ id: "e9", source: "css", target: "conn-css-style" },
		{ id: "e10", source: "conn-css-style", target: "style" },
		{ id: "e11", source: "css", target: "conn-layout" },
		{ id: "e12", source: "conn-layout", target: "layout" },
		{ id: "e13", source: "style", target: "conn-style" },
		{ id: "e14", source: "conn-style", target: "color" },
		{ id: "e15", source: "conn-style", target: "size" },
		{ id: "e16", source: "js", target: "conn-events" },
		{ id: "e17", source: "conn-events", target: "events" },
		{ id: "e18", source: "events", target: "conn-clicks" },
		{ id: "e19", source: "conn-clicks", target: "click" },
		{ id: "e20", source: "events", target: "conn-alerts" },
		{ id: "e21", source: "conn-alerts", target: "alert" },
		{ id: "e22", source: "events", target: "conn-changes" },
		{ id: "e23", source: "conn-changes", target: "change" },
	],
};
