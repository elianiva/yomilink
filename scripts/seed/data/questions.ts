...
export const READING_COMPREHENSION_QUESTIONS: ReadingQuestion[] = [
	...
	{
		questionText: "この町で、一番いい店はどこですか。",
		options: createMcqOptions(15, ["スーパー", "花屋", "パン屋", "喫茶店"]),
		correctOptionId: generateOptionId(15, 0),
		bloomLevel: "L5-Evaluating",
		targetInfo: "Evaluate which store offers the most based on passage details",
	},
	{
	...
	{
		questionText: "この町で何ができますか。",
		options: createMcqOptions(17, [
			"本を借りて、読んで、コーヒーを飲むことができます",
			"映画を見て、音楽を聞くことができます",
			"電車に乗って、買い物に行くことができます",
			"手紙を書いて、電話をすることができます",
		]),
		correctOptionId: generateOptionId(17, 0),
		bloomLevel: "L6-Creating",
		targetInfo: "Synthesize passage activities into what is possible in the town",
	},
	{
		questionText: "「わたしのうち」の話で地図を作ります。地図の真ん中はどこですか。",
	...
	{
		questionText: "友達がこの町のことを聞きました。何と答えますか。",
		...
		bloomLevel: "L6-Creating",
		targetInfo: "Create a synthesized description using passage details",
	},
];
