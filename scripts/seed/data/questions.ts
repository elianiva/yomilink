...
// Generate stable option IDs for reading comprehension questions
function generateOptionId(questionIndex: number, optionIndex: number): string {
	return `q${questionIndex}_opt${optionIndex}`;
}
...
export const READING_COMPREHENSION_QUESTIONS: ReadingQuestion[] = [
	{
		...
		options: createMcqOptions(0, ["午前6時", "午前7時", "午前8時", "午前9時"]),
	...
	},
	{
		...
		options: createMcqOptions(1, ["2時間", "3時間", "4時間", "5時間"]),
	...
	},
	{
		...
		options: createMcqOptions(2, ["家", "学校の学食（きっさてん）", "レストラン", "図書館"]),
	...
	},
	{
		...
		options: createMcqOptions(3, ["午後9時", "午後10時", "午後11時", "午前0時"]),
	...
	},
	{
		...
		correctOptionId: generateOptionId(11, 1),
		bloomLevel: "L3-Applying",
	...
	},
	{
		...
		correctOptionId: generateOptionId(12, 1),
	...
	},
	{
		...
		correctOptionId: generateOptionId(16, 1),
	...
	},
	{
		...
		correctOptionId: generateOptionId(19, 1),
		bloomLevel: "L5-Evaluating",
	...
	},
	{
		...
		correctOptionId: generateOptionId(20, 1),
	...
	},
	{
		...
		correctOptionId: generateOptionId(21, 1),
		bloomLevel: "L6-Creating",
